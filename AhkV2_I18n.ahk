...
`"X-Generator: AhkV2_I18n {1}\n`"
    ...
    static _commandLineToArgvW(cmdLine := "")    { ;  https://github.com/SevenKeyboard/command-line-to-argv-w/tree/main-ahkv2.0
        args := []
    ...
    static _getFullPathName(fileName)    { ;  https://github.com/SevenKeyboard/get-full-path-name/tree/main-ahkv2.0
